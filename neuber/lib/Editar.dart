...
void _mostrarDialogoEdicion(Map<String, dynamic> proyecto) {
  ...
  showDialog(
    ...
    builder: (BuildContext context) {
      ...
      Future<void> seleccionarFecha(String fecha) async {
      ...
      void actualizarPiezas(String value) {
              ...
              child: ListView(
                ...
                children: [
                  ...
                  _textFieldEditar(
                    ...
                    onChanged: (value) {
                      setState(() {
                        actualizarPiezas(value);
                      });
                    },
                  ),
                  const SizedBox(height: 20),
                  ElevatedButton(
                    onPressed: () => seleccionarFecha('Fecha de inicio'),
                    child: Text('Seleccionar Fecha de Inicio'),
                  ),
                  const SizedBox(height: 20),
                  ElevatedButton(
                    onPressed: () => seleccionarFecha('Fecha de fin'),

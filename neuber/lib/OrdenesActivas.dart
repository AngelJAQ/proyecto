...
class OrdenesActivasPage extends StatefulWidget {
  const OrdenesActivasPage({super.key});
  ...
  Future<List<Map<String, dynamic>>> _loadProyectos() async {
    ...
    if (response.statusCode == 200) {
      ...
      if (decodedData.containsKey('records')) {
        ...
        // Filtrar solo las órdenes de trabajo con estado "Pendiente"
        proyectos = proyectos.where((proyecto) => proyecto['Estado'].toString() == 'Pendiente').toList();
